...
4.  planning-and-task-breakdown → Break into small, verifiable chunks
5.  context-engineering         → Load the right context
6.  source-driven-development   → Verify against official docs
7.  incremental-implementation  → Build slice by slice
8.  doubt-driven-development    → Adversarial fresh-context review of every non-trivial decision
